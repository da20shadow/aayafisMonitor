...
<div class="container">
    ...
    <p class="text-center fst-italic" style="font-size:13px;">DISCLAIMER: We do not own or promote any programs listed
        here.
...
<footer class="container py-3 my-4">
    ...
    <p class="text-center text-light">©<?php echo $date ?> AyaafisMonitor.com - All Rights Reserved!</p>
